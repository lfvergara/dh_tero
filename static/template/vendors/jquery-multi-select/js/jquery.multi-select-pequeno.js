...
!function ($) {
  ...
  * ====================== */
  ...
  var MultiSelect = function (element, options) {
    ...
    this.$container = $('<div/>', { 'class': "ms-container-pequeno" });
    this.$selectableContainer = $('<div/>', { 'class': 'ms-selectable' });
    this.$selectionContainer = $('<div/>', { 'class': 'ms-selection' });
    this.$selectableUl = $('<ul/>', { 'class': "ms-list-pequeno", 'tabindex' : '-1' });
    this.$selectionUl = $('<ul/>', { 'class': "ms-list-pequeno", 'tabindex' : '-1' });
    this.scrollTo = 0;
  ...
  MultiSelect.prototype = {
    ...
    init: function(){
      ...
      if (ms.next('.ms-container-pequeno').length === 0){
