var BlitzMap = new function(){
  ...
  function editarPoligono(result){
    ...
    $.ajax({
            type: "POST",
            url: "/web/app/mantenimientopreventivo/editar_coordenadas_mantenimientopreventivo",
            data: {'mantenimientopreventivo_id': mantenimientopreventivo_id,'array': JSON.stringify(result)},
            success: function(){
             window.location.href = "/web/app/mantenimientopreventivo/configuracion/" + mantenimientopreventivo_id;
            }
    });
  }
