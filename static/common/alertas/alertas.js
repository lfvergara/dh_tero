...
function confirma_formulario(tipo, path) {  
  ...
  //var enlace = "/dh_tero/static/common/alertas/confirma_formulario.html";        
  ...
  switch(tipo) {
    ...
    case 4:
      ...
      break;
    case 5:
      var msg = "Está por AUTORIZAR la OP ¿Desea continuar?";
      break;
    case 6:
      var msg = "Está por RECHAZAR la OP ¿Desea continuar?";
      break;
  }
