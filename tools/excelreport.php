...
class ExcelReport extends View {
  ...
  function extraer_informe_conjunto($subtitulo, $array_exportacion) {
    ...
    $objPHPExcel->getProperties()->setCreator("DHARMA")
                                 ...
                                 ->setTitle("informesDharma")
                                 ->setSubject("informesDharma")
                                 ->setDescription("informesDharma")
                                 ->setKeywords("informesDharma")
                                 ->setCategory("informesDharma");

    $tituloReporte = "EDELAR SA";
