...
class ExcelReport extends View {
  ...
  function extraer_informe_conjunto($subtitulo, $array_exportacion) {
    ...
    $objPHPExcel->getProperties()->setCreator("Zorzal")
                                 ->setLastModifiedBy("Zorzal")
                                 ->setTitle("informesZorzal")
                                 ->setSubject("informesZorzal")
                                 ->setDescription("informesZorzal")
                                 ->setKeywords("informesZorzal")
                                 ->setCategory("informesZorzal");

    $tituloReporte = "Pañol Zorzal";
    $fechaReporte = date("d-m-Y");
    $softReporte = "dhZorzal";
    ...
    $objPHPExcel->getActiveSheet()->setTitle("infZorzal");
    $objPHPExcel->setActiveSheetIndex(0);
    $objPHPExcel->getActiveSheet(0)->freezePaneByColumnAndRow(0,4);

    header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
    header('Content-Disposition: attachment;filename="infZorzal.xlsx"');
